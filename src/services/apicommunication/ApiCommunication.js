...
class ApiCommunication {
  ...
  /**
   * @author lfb0801
   * @description a new function to make a graphql request that should be superior to all others
  ...
  static graphQLRequest(_method, _function, _queryData, _variables){
    return axios.post(
      this.endpoint,
      GraphQLRG.generateBody(_method, _queryData, _queryData, _variables),
      { headers: { "Content-type": "application/json" } }
    );
  }
